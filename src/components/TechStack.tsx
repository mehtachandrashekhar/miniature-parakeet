    ...
    <section className="py-24 px-6 max-w-6xl mx-auto" id="tech-stack">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        {techStack.map((group, groupIndex) => (
          <motion.div
            ...
            className="glass p-8 rounded-3xl border-gray-200 dark:border-gray-800/50 hover:border-blue-500/30 transition-all group"
          >
            <div className="flex items-center gap-4 mb-8">
              <div className="p-3 bg-blue-500/10 rounded-2xl text-blue-600 dark:text-blue-400 group-hover:scale-110 transition-transform">
                {group.icon}
              </div>
              <h3 className="text-2xl font-bold text-black dark:text-white">{group.category}</h3>
            </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-16">
        {[
          ...
          <div key={i} className="flex items-center justify-center gap-2 py-3 glass rounded-xl text-gray-600 dark:text-gray-400 text-sm border-gray-200 dark:border-gray-800/30">

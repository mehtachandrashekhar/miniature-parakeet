    ...
    <section className="py-24 px-6 max-w-6xl mx-auto" id="about">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <motion.div
          ...
          className="relative"
        >
          <div className="absolute -inset-4 bg-gradient-to-tr from-blue-600/10 to-emerald-600/10 rounded-[2rem] blur-2xl" />
          <div className="relative glass p-8 rounded-[2rem] border-gray-200 dark:border-gray-800/50">
